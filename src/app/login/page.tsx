...
const CALLBACK_ERROR_MESSAGES: Record<string, string> = {
  auth_callback_failed: 'That link has expired or was already used. Please try signing in, or request a new link.',
}
...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(() => {
    ...
    return code ? (CALLBACK_ERROR_MESSAGES[code] ?? 'Something went wrong signing you in. Please try again.') : null
  })
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleEmailLogin}>
          ...
          <div style={{ marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
              ...
              <Link href="/forgot-password" style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#135bec', textDecoration: 'none' }}>
                Forgot password?
              </Link>
            </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '0.875rem', color: '#64748b' }}>
          ...
          <Link href="/signup" style={{ color: '#135bec', fontWeight: 600, textDecoration: 'none' }}>
            Sign up
          </Link>
        </p>
      </div>
